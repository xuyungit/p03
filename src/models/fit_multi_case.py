...
class MultiCaseFitter:
    """Joint fitting of constant structural parameters and varying temperatures."""
    ...
    def _residual(
        ...
        """Compute stacked residuals for all cases."""
    ...
    def fit(
        ...
        residuals = self._residual(result.x, fit_struct).reshape(self.n_cases, 4)
...
def main():
    parser = argparse.ArgumentParser(
        description="多工况联合拟合：固定结构参数 + 变化温度梯度"
    )
    parser.add_argument(
        '--data',
        type=Path,
